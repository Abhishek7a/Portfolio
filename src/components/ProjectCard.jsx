  ...
  return (
    <div className="mx-auto my-5 ">
      <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl  md:h-72 mx-2">
        <div className={`z-0 order-1 md:order-2 relative  w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg  ${dark=== false? "dark:text-gray-100 bg-gray-800":"bg-gray-100"} `}>
          <div
        ...
        <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
          <div className={`p-8 md:pr-18 md:pl-14 md:py-12 mx-2 md:mx-0 h-full  rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none ${dark=== false? "dark:text-gray-100 bg-gray-900":"bg-gray-100"} `}>
            <h4 className="hidden md:block text-xl text-white">
            {/* {props.title} */}
            </h4>
            <h3 className="hidden md:block font-bold text-2xl ">
              {props.title}
            </h3>
