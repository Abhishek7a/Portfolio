  ...
  const experiences = [
    {
      ...
      duration: "Intern (Full Time) → Permanent | Jan 2024 - Present",
      color: "bg-green-600",
      borderColor: "border-green-600",
      pulse: true, // Pulse only on the most recent/current job
    },
    {
      company: "JP Morgan Chase",
      role: "Internship",
      duration: "1 Month (15/7/2023 - 15/8/2023)",
      color: "bg-orange-600",
    ...
    },
    {
      ...
      role: "Internship",
      duration: "3 Months (15/7/2023 - 15/8/2023)",
      color: "bg-orange-600",
      borderColor: "border-orange-600",
      pulse: false,
    },
        ...
        {experiences.map((exp, index) => (
          <li key={index} className={`mb-6 ${exp.borderColor}`}>
            <div className="flex items-start sm:flex-row flex-col ">
              ...
              <div
                className={`w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-full -ml-3.5 sm:-ml-4 ${
                  exp.color
                } text-white ${exp.pulse ? "animate-pulse" : ""}`}
              >
              ...
              {/* Experience Card */}
              <div
                className={`block px-6 sm:px-8 py-4 sm:py-2 w-full sm:w-100 rounded-lg shadow-lg ml-6 ${
                  dark === false
